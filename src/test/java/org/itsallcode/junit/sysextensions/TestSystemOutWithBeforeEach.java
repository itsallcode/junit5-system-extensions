...
{
    @BeforeEach
    void beforeEach(final CapturingOutputStream stream)
    {
    ...
    @Test
    void testCaptureAfterEachA(final CapturingOutputStream stream)
    {
    ...
    @Test
    void testCaptureAfterEachB(final CapturingOutputStream stream)
    {
